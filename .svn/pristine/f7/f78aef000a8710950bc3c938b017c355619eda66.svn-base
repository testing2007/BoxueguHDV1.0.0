...
class BXGUserCenterOBJC: NSObject {
    @objc public static var userId: String? {
        if let userModel = BXGUserCenter.shared.userModel {
            return userModel.user_id
        }
        return nil
    }
    @objc public static var sign:       String? {
        if let userModel = BXGUserCenter.shared.userModel {
            return userModel.sign
        }
        return nil
    }
    ...
    @objc public static var head_img:   String? {
        if let userModel = BXGUserCenter.shared.userModel {
            return userModel.head_img
        }
        return nil
    }
    @objc public static var nickname:   String? {
        if let userModel = BXGUserCenter.shared.userModel {
    ...
    @objc public static var cc_user_id: String? {
        if let userModel = BXGUserCenter.shared.userModel {
            return userModel.cc_user_id
        }
        return nil
    }
    @objc public static var cc_api_key: String? {
        if let userModel = BXGUserCenter.shared.userModel {
            return userModel.cc_api_key
        }
        return nil
    }
    @objc public static var cc_live_user_id: String? {
        if let userModel = BXGUserCenter.shared.userModel {
            return userModel.cc_live_user_id
        }
        return nil
    }
    @objc public static var cc_live_playback_key: String? {
        if let userModel = BXGUserCenter.shared.userModel {
            return userModel.cc_live_playback_key
        }
        return nil
    }
    @objc public static var itcast_uuid: String? {
        if let userModel = BXGUserCenter.shared.userModel {
            return userModel.itcast_uuid
        }
        return nil
    }
