...
class BXGCoursePlayerView: UIView {
...
extension BXGCoursePlayerView: BXGPlayerManagerDelegate {
...
extension BXGCoursePlayerView: BXGPlayerListManagerDelegate {
