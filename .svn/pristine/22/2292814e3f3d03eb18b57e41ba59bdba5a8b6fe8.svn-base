...
-(DWDownloadState)convertCCDownloadState:(BXGDownloadState)downloadState {
    DWDownloadState state = DWDownloadStateNone;
    switch (downloadState) {
        case BXGDownloadStateNone:
            state = DWDownloadStateNone;
            break;
        case BXGDownloadStateReadying:
            state = DWDownloadStateReadying;
            break;
        case BXGDownloadStateRunning:
            state = DWDownloadStateRunning;
            break;
        case BXGDownloadStateSuspended:
            state = DWDownloadStateSuspended;
            break;
        case BXGDownloadStateCompleted:
            state = DWDownloadStateCompleted;
            break;
        case BXGDownloadStateFailed:
            state = DWDownloadStateFailed;
            break;
        default:
            NSAssert(FALSE, @"can't be happen");
            break;
