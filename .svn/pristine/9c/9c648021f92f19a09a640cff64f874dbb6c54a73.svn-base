//
//  BXGDownloadSelectHeaderView.swift
//  BoxueguHD
//
...
protocol BXGDownloadSelectHeaderViewDelegate : AnyObject {
    func openSection(sectionId:Int) -> Void;
    func closeSection(sectionId:Int) -> Void;
}

class BXGDownloadSelectHeaderView: UITableViewHeaderFooterView {

    var sectionId:Int
//    var isOpen:Bool
    weak var delegate:BXGDownloadSelectHeaderViewDelegate?
