...
class BXGMainNavVC: UINavigationController {
    ...
    func createBackItemTarget(target:AnyObject, backAction:Selector) -> UIBarButtonItem {
        ...
        let imageIcon:UIImage = #imageLiteral(resourceName: "navigation_back").withRenderingMode(UIImageRenderingMode.alwaysOriginal)
...
class BXGMainVC: UITabBarController {
    ...
    func installChildVC() {
        ...
        addChildVC(title: "直播",
                   viewControllerClass: BXGConstrueVC.self,
        ...
        addChildVC(title: "调试",
                   ...
                   imageName: "tabbar_download",
                   selectedImageName: "tabbar_download_selected")
//        addChildVC(title: "调试2",
//                   viewControllerClass: TestDWViewController.self,
//                   imageName: "tabbar_download",
//                   selectedImageName: "tabbar_download_selected")
