//
//  BXGSectionExamResultQuestionCell.swift
//  BoxueguHD
//
//  Created by mynSoo Wu on 2018/7/22.
//  Copyright © 2018年 itcast. All rights reserved.
//

import UIKit

class BXGSectionExamResultQuestionCell: UITableViewCell {
    ...
    func installData(type: BXGStudySectionExamQuestionType, title: String?) {
        ...
        if let title = title, let data = title.data(using: String.Encoding.utf8) {
            do {
